...
const SLUG = "mississauga-insurance-broker";

export const metadata: Metadata = {
  title: "Mississauga Insurance Broker | RIBO Licensed | Sharan Kaur",
  description:
    "Looking for an insurance broker in Mississauga? Sharan Kaur is RIBO-licensed and compares 30+ carriers for auto, home, and life insurance. Get a free quote today.",
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does car insurance cost in Mississauga?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Car insurance costs in Mississauga vary based on your driving history, vehicle, and coverage needs. Sharan Kaur, a RIBO-licensed broker, compares rates from 30+ carriers to help Mississauga drivers find the most affordable policy with the right coverage.",
      },
    },
    {
      "@type": "Question",
      name: "Do you offer home insurance for condos and rentals in Mississauga?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, Sharan Kaur helps Mississauga homeowners, condo owners, and renters find tailored home insurance coverage, comparing options from multiple carriers to fit your property and budget.",
      },
    },
  ],
};
...
export default function MississaugaInsuranceBrokerPage() {
  return (
