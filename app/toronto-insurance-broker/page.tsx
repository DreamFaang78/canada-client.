...
const CITY = "Toronto";
const SLUG = "toronto-insurance-broker";

export const metadata: Metadata = {
  title: "Toronto Insurance Broker | RIBO Licensed | Sharan Kaur",
  description:
    "Looking for an insurance broker in Toronto? Sharan Kaur is RIBO-licensed and compares 30+ carriers for auto, home, and life insurance. Get a free quote today.",
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Is auto insurance more expensive in Toronto than in Mississauga?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Auto insurance rates in Toronto can be higher than in Mississauga due to traffic density and claims history in the area. Sharan Kaur, a RIBO-licensed broker, compares 30+ carriers to find Toronto drivers the most competitive rate available.",
      },
    },
    {
      "@type": "Question",
      name: "Can I get home insurance for a Toronto condo through a broker?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes, Sharan Kaur helps Toronto condo owners and renters find tailored home insurance coverage, comparing options from multiple carriers to fit your unit and budget.",
      },
    },
  ],
};
...
export default function TorontoInsuranceBrokerPage() {
  return (
